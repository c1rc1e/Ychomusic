<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"D:\PHPTutorial\WWW/app/admin\view\ranks\create.html";i:1500238772;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo isset($info['id'])?'编辑':'新增'; ?>榜单</h3>
    </div>
            ...
            <div class="col-md-8">          
                <form class="form-horizontal form-fixed form-submit" action="<?php echo isset($info['id'])? url('update') : url('save'); ?>">
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 text-right control-label">榜单名称</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 text-right control-label">榜单别名</label>
                        <div class="col-md-4 col-xs-12">
                            <input type="text" name="alias" class="form-control" value="<?php echo (isset($info['alias']) && ($info['alias'] !== '')?$info['alias']:''); ?>">
                            <span class="help-block">留空将自动获取拼音</span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 text-right control-label">榜单排序</label>
                        <div class="col-md-2 col-xs-12">
                            <input type="text" name="sort" class="form-control" value="<?php echo (isset($info['sort']) && ($info['sort'] !== '')?$info['sort']:''); ?>">
                            <span class="help-block">留空将自动排序</span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2 control-label">榜单简介</label>
                        <div class="col-md-10">
                            <textarea id="ranks-introduce" rows="16" class="form-control" name="introduce"><?php echo (isset($info['introduce']) && ($info['introduce'] !== '')?$info['introduce']:''); ?></textarea>
                        </div>
                    </div>
...
<?php echo hook('articleEdit', ['wiget'=>'wangEditor','is_admin' => true,'element' => 'ranks-introduce']); ?>
...
<?php echo hook('articleEdit', ['wiget'=>'wangEditor','is_admin' => true,'element' => 'ranks-introduce']); endif; ?>