<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\PHPTutorial\WWW\resources\web\default\home\music_down.html";i:1502218637;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;}*/ ?>
<!doctype html>
	...
	<div class="down_page container">
		<section class="col-sm-9 m_xs_bottom_10">
			...
			<div class="row clearfix pt_10">	
				...
				<div class="col-lg-9 col-md-9 col-sm-12">				
					<div class="pull-left">
						<a href="<?php echo $data['url']; ?>"><img height="70" width="70" src="<?php echo $data['cover_url']; ?>"></a>
					</div>
						
					<div class="pull-left ml_20">
						<h4 class="mb_20">
                            <?php if(!(empty($data['artist_name']) || (($data['artist_name'] instanceof \think\Collection || $data['artist_name'] instanceof \think\Paginator ) && $data['artist_name']->isEmpty()))): ?><?php echo $data['artist_name']; ?> -- <?php endif; ?> <?php echo $data['name']; ?>
						</h4>
			...
			<div class="row clearfix mb_20 pt_10">
				<div class=" col-lg-6 col-md-6 col-sm-12">
					...
					<span class="mb_15 d_block">所属分类：<a href="<?php echo $data['genre_url']; ?>"><?php echo $data['genre_name']; ?></a></span>
				</div>	
				<div class=" col-lg-6 col-md-6 col-sm-12">						
			...
			<div class="row clearfix mb_20 pt_10">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<span class="mb_15 d_block">如果还没登录的请点上方登录按钮</span>
				</div>							
			</div>
		...
		<aside class="col-lg-3 col-md-3 col-sm-3">
			...
			<div class="sidebar_content">
				<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["limit"] = 15;$param["order"] = "download";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
