<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\PHPTutorial\WWW\resources\web\default\user\account_index.html";i:1509803924;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_common.html";i:1502370209;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;}*/ ?>
<!doctype html>
...
<div class="tabbable tabbable-custom tabbable-reversed">
	...
	<div class="tab-content clearfix">
		<p class="mb_10">你的账号：<?php echo $user['username']; ?>(ID:<?php echo $user['uid']; ?>)</p>
		<p class="mb_10">你的昵称：<?php echo $user['nickname']; ?></p>
		<p class="mb_10">
			所在用户组：<?php echo $user['group']['name']; ?>
			<img height="20" src="<?php echo $user['group']['icon_url']; ?>">
            <a href="<?php echo url("user/Account/upgrade");?>">升级/续费</a>
		</p>
        <?php if($user['group']['id'] > '1'): ?>
        <p class="mb_10">
        到期时间：<?php echo time_format($user['group']['end_time']); ?>
        </p>
        <?php endif; ?>

		<p class="mb_10">你的邮箱：<?php echo $user['email']; ?></p>
		<p class="mb_10">注册时间：<?php echo $user['reg_time']; ?></p>

		<p>你的金币余额：<?php echo $user['coin']; ?>
