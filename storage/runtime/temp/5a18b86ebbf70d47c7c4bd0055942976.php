<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\PHPTutorial\WWW\resources\web\default\user\index_album.html";i:1502218637;s:63:"D:\PHPTutorial\WWW\resources\web\default\user\index_common.html";i:1522921022;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;}*/ ?>
<!doctype html>
...
<div class="row">
	<div class="col-sm-8">
		<div class="header">TA的专辑</div>
		<div class="row clearfix album_list">
			<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["page"] = 1;$param["uid"] = $user['uid'];$param["limit"] = 32;$param["order"] = "create_time";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(!empty($__MUSIC__)) : $v_page = $__MUSIC__->render();$v_total = $__MUSIC__->total(); else: $v_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
			<div class="col-sm-3">
	...
	<div class="col-sm-4 aside">
		...
		<div class="user-fans">
			...
			<ul class="clearfix">				
				<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["uid"] = $user['uid'];$param["limit"] = 24;$memberModel = isset($memberModel)?$memberModel:new \app\common\model\Member();$__MUSIC__ = $memberModel->getVisitors($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
				<li>
