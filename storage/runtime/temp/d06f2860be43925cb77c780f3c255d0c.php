<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"D:\PHPTutorial\WWW/app/admin\view\user\index.html";i:1511193241;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
        ...
        <div class="btn-toolbar m-t-20" role="toolbar">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="<?php if($status == 'audit'): ?>active<?php endif; ?>">
                        <a class="list-group-item b-0" href="<?php echo url('?status=audit'); ?>">
                            <i class="fa fa-circle text-warning m-r-10"></i>未激活
                        </a>
                    </li>
            ...
            <!--div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo url('index'); ?>">全部</a></li>
                </ul>
            </div-->

            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo url('create'); ?>">新增用户</a>
            </div>
            ...
            <table class="table table-hover mails m-0 table table-actions-bar">
                        ...
                        <th width="80">
                            ...
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo url('?field=id&order=desc'); ?>">UID倒序</a></li>
                                    <li><a href="<?php echo url('?field=id&order=asc'); ?>">UID正序</a></li>
                                    <li><a href="<?php echo url('?field=coin&order=desc'); ?>">最多金币</a></li>
                                    <li><a href="<?php echo url('?field=score&order=desc'); ?>">最多积分</a></li>
                                    <li><a href="<?php echo url('?field=login&order=desc'); ?>">登录次数</a></li>
                                    <li><a href="<?php echo url('?field=hits&order=asc'); ?>">最多点击</a></li>
                                </ul>
                            </div>
                        </th>
                        <th>用户ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php  $group = get_user_in_group($vo['id']) ?>
                            <?php echo $group['name']; ?>
                        </td>
                        <td><?php echo long2ip($vo['last_login_ip']); ?></td>
                        <td><?php echo time_format($vo['last_login_time'],"Y-m-d"); ?></td>
                        <td>
                            <a href="<?php echo url('toGroup?uid='.$vo['id']); ?>" class="table-action-btn open-form-modal">
                            ...
                            <?php if($vo['status'] == 1): ?>
                            <a class="table-action-btn ajax-get" title="禁用[<?php echo $vo['nickname']; ?>]" href="<?php echo url('setStatus?id='.$vo['id'].'&status=0'); ?>">
                                <i class="fa fa-ban text-warning"></i>
                            </a>
                            <?php elseif($vo['status'] == 0): ?>
                            <a class="table-action-btn ajax-get" title="启用[<?php echo $vo['nickname']; ?>]" href="<?php echo url('setStatus?id='.$vo['id'].'&status=1'); ?>">
                                <i class="fa fa-check-circle-o text-success"></i>
                            </a>
                            <?php elseif($vo['status'] == 2): ?>
                            <a class="table-action-btn ajax-get" title="激活[<?php echo $vo['nickname']; ?>]" href="<?php echo url('setStatus?id='.$vo['id'].'&status=1'); ?>">
                                <i class="fa fa-check-circle-o text-success"></i>
                            </a>
                            <?php endif; ?>
                            <a href="<?php echo url('delete?id='.$vo['id']); ?>" title="<?php echo $vo['nickname']; ?>" class="table-action-btn ajax-del">
