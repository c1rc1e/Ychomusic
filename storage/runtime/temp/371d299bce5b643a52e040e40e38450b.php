<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\PHPTutorial\WWW\resources\web\default\home\search_songs.html";i:1508711992;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
	...
	<div class="container">	
		<div class="row clearfix">
			...
			<section class="col-sm-10 col-sm-offset-1">
				<div class="clearfix">
					<h3 class="pull-left pt_10"> [ <?php echo $keys; ?> ]</span>的相关音乐</h3>
					<ul class="tabs_nav pull-right">
						<li class="active"><a href="javascript:;" class="d_block ">歌曲</a></li>
						<li><a href="<?php echo url("home/Search/index");?>" data-type="3" class="d_block change-search">搜索相关专辑</a></li>
						<li><a href="<?php echo url("home/Search/index");?>" data-type="2" class="d_block change-search">搜索相关艺人</a></li>
					</ul>
				</div>
				<hr>
				<div class="tab-content mt_20">							
					<div class="tab-pane fade in active">
					<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $__JYLIST__ = $list;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						...
						<div class="row clearfix mb_5">
							<div class="col-sm-6">
								<span class="page_total">共查询相关歌曲【<?php echo $_total; ?>】个</span>
							</div>
							<div class="col-sm-6 t_align_r">
								<ul class="horizontal_list pull-right page_list"><?php echo $_page; ?></ul>
							</div>
						</div>
					<?php else: ?>
...
<script type="text/javascript">
    $('.change-search').each(function () {
        ...
        url +=  'type=' + $this.data('type') +"&keys=<?php echo $keys; ?>";
        $this.attr('href', url);
    })
</script>
