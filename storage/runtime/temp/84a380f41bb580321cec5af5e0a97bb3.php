<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:63:"D:\PHPTutorial\WWW\resources\web\default\home\album_detail.html";i:1523009587;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\sidebar_adver.html";i:1502218637;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
			...
			<section class="col-sm-8 ">
				<div class="row clearfix">
					<div class="col-sm-4">
						<div class="photoframe a_cover">
							<img src="<?php echo $data['cover_url']; ?>" class="tr_all_hover " alt="<?php echo $data['name']; ?>" >
						</div>
					</div>

					<div class="col-sm-7">
						<h2 class="mt_10"><i class="jy jy-cdcover mr_10"></i><?php echo $data['name']; ?></h2>
						<?php if(!empty($data['artist_name'])): ?>
						<p class="mt_5">所属歌手:<a href="<?php echo $data['artist_url']; ?>" class="color_green"><?php echo $data['artist_name']; ?></a></td>
						<?php endif; if(!empty($data['type_name'])): ?>
						<p class="mt_5">所属类型:<a href="javascript:;" class="color_grey mr_20"><?php echo $data['type_name']; ?></a></p>
						<?php endif; ?>
						<p class="mt_5">发行时间:<?php echo empty($data['pub_time'])? '未知' : $data['pub_time']; ?></p>
						<p class="mt_5">唱片公司:<?php echo empty($data['company'])? '未知' : $data['company']; ?></p>
						<p><?php echo hook('pageBody',array('widget'=>'Baidushare')); ?></p>
						<p class="mt_10">
							<button class="btn_1 album_play pull-left mr_10"  title="<?php echo $data['name']; ?>" data-id="<?php echo $data['id']; ?>"><i class="jy jy-listen mr_10"></i>播放专辑</button>
							<button class="btn_1 pull-left music-action-btn mr_10 relative" data-id="<?php echo $data['id']; ?>" data-action="fav" data-type="album" ><span class="tooltip tr_all_hover  ">收藏[<?php echo $data['favtimes']; ?>]</span><i class="jy jy-fav"></i></button>
						</p>
					</div>
				</div>
				...
				<div class="clearfix">
					...
					<div class="mt_15 mb_20">
						...
						<div class="tab-content">
							<div id="ta-1" class="tab-pane fade in active">
								<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["page"] = 1;$param["album"] = $data['id'];$param["limit"] = 20;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(!empty($__MUSIC__)) : $v_page = $__MUSIC__->render();$v_total = $__MUSIC__->total(); else: $v_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
								<div class="mb_10 clearfix relative play_box">
									<div class="row clearfix song_list">
										...
										<span class="col-sm-3 col-xs-2 p_hr_0">
											<a class="text-ellipsis singer" target="_sing" href="<?php echo $v['genre_url']; ?>"><?php echo $v['genre_name']; ?></a>
										</span>
										<span class="col-sm-2 ls_listen hidden-xs"><?php echo number_format($v['listens']); ?></span>
                                ...
                                <div class="clearfix mb_5 t_align_c">
                                    <ul class="clearfix d_inline_middle ml_10 page_list"><?php echo $v_page; ?></ul>
                                </div>
					...
					<div class="hot-carousel mb_15">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 20;$param["order"] = "hits";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<figure class=" photoframe shadow relative tr_all_hover">
							<a href="<?php echo $v['url']; ?>" target="_album" class="d_block relative animate_half_tc" >
								<img src="<?php echo $v['cover_url']; ?>" width="100%">
							</a>
							<figcaption class="t_align_c mt_10">
								<h5 class="mb_5">
									<a href="<?php echo $v['url']; ?>" target="_album" class="text-ellipsis"><?php echo $v['name']; ?></a>
								</h5>
							</figcaption>
						</figure>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					...
					<div class="clearfix">
						<?php echo hook('documentDetailAfter',array('type'=>'album','id'=>$data['id'])); ?>
					</div>
				</div>
			</section>

			<aside class="col-sm-4">
				<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 15;$param["order"] = "listens";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
				<div class="mb_10 clearfix relative play_box">
					<div class="row clearfix song_list">
...
$(document).ready(function () {
    $.ajax({
        ...
        data: {id: "<?php echo $data['id']; ?>", type : 'album'},
        dataType: "jsonp"
    });
});
</script>
