<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"D:\PHPTutorial\WWW/app/admin\view\album_type\create.html";i:1502562932;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo isset($info['id'])?'编辑':'新增'; ?>专辑类型</h3>
    </div>
    <div class="panel-body">       
        <form class="form-horizontal form-fixed form-submit" action="<?php echo isset($info['id'])? url('update') : url('save'); ?>">
            <div class="form-group">
                <label class="col-md-2 col-xs-12 text-right control-label">类型名称</label>
            ...
            <div class="form-group">
                <label class="col-md-2 col-xs-12 text-right control-label">类型别名</label>
