<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"D:\PHPTutorial\WWW/app/admin\view\article\index.html";i:1500882530;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:54:"D:\PHPTutorial\WWW\app\admin\view\article\sidebar.html";i:1497744848;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
...
<body class="fixed-left">
    ...
    <ul class="nav nav-main" id="slider-nav-main" data-ride="collapse">
        <?php if(is_array($menu_list['child']) || $menu_list['child'] instanceof \think\Collection || $menu_list['child'] instanceof \think\Paginator): if( count($menu_list['child'])==0 ) : echo "" ;else: foreach($menu_list['child'] as $key=>$sub_menu): if(!(empty($sub_menu) || (($sub_menu instanceof \think\Collection || $sub_menu instanceof \think\Paginator ) && $sub_menu->isEmpty()))): ?>
        <li class="sub-nav">
        ...
        <li class="sub-nav">
            ...
            <ul class="list-unstyled" style="display: block">
                <?php $_5bd2fa824851d=get_article_cate_tree(); if(is_array($_5bd2fa824851d) || $_5bd2fa824851d instanceof \think\Collection || $_5bd2fa824851d instanceof \think\Paginator): if( count($_5bd2fa824851d)==0 ) : echo "" ;else: foreach($_5bd2fa824851d as $key=>$sl_cate): ?>
                <li>
                    <a id="sub-cate-<?php echo $sl_cate['id']; ?>" href="<?php echo url('article/index?cate='. $sl_cate['id']); ?>" class="auto">
                        <i class="fa fa-angle-right"></i>
                        <span><?php echo $sl_cate['title']; ?></span>
                    </a>
                    <?php if(isset($sl_cate['_child'])): ?>
                    <ul style="display: block;">
                        <?php if(is_array($sl_cate['_child']) || $sl_cate['_child'] instanceof \think\Collection || $sl_cate['_child'] instanceof \think\Paginator): if( count($sl_cate['_child'])==0 ) : echo "" ;else: foreach($sl_cate['_child'] as $key=>$sl_sub_cate): ?>
                        <li>
                            <a id="sub-cate-<?php echo $sl_sub_cate['id']; ?>" href="<?php echo url('article/index?cate='. $sl_sub_cate['id']); ?>" class="">
                                <i class="fa fa-angle-right"></i>
                                <span><?php echo $sl_sub_cate['title']; ?></span>
                            </a>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
...
<div class="row">
    <div class="col-sm-4">
        <h4 class="page-title">音乐资讯管理</h4>
    </div>
    <div class="col-sm-4 pull-right text-right text-left-xs m-t-md">
        <form class="searchform" action="<?php echo url(); ?>">
...
<div class="row">
    <div class="col-lg-12">
        <div class="btn-toolbar m-t-20" role="toolbar">
            ...
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo url('create?cate='. $cate); ?>">新增资讯</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <a href="<?php echo url('setStatus?status=-1&id='.$vo['id']); ?>" title="<?php echo $vo['title']; ?>" class="table-action-btn ajax-del">
...
<script type="text/javascript">
var curCate = "<?php echo $cate; ?>";
$(function ($) {
    //高亮标题
    if (curCate.length > 0) {
        $('#slider-nav-main').find('a').removeClass('active');
        $('#sub-cate-' + curCate).addClass('active');
    }
});
</script>
