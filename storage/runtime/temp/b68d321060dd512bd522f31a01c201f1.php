<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\PHPTutorial\WWW\resources\web\default\user\music_audit.html";i:1502218637;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_common.html";i:1502370209;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;}*/ ?>
<!doctype html>
...
<div class="tabbable tabbable-custom tabbable-reversed">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:;">正在审核</a></li>
	...
	<div class="tab-content clearfix">
		...
		<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["page"] = 1;$param["uid"] = $user['uid'];$param["status"] = 2;$param["field"] = "id,name,genre_id,album_id";$param["limit"] = 20;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(!empty($__MUSIC__)) : $v_page = $__MUSIC__->render();$v_total = $__MUSIC__->total(); else: $v_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
		<div class="mb_10 clearfix relative play_box">
			<div class="row clearfix song_list">								
