<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\PHPTutorial\WWW\resources\web\default\home\genre_index.html";i:1503390484;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
		...
		<div class="row clearfix">
				...
				<div class="sidebar_content">
					<div class="clearfix s_cats">
						<?php $param = []; $param["status"]=1;$param["result"] = "vo";$param["limit"] = 20;$genreModel = isset($genreModel)?$genreModel:new \app\common\model\Genre();$__MUSIC__ = $genreModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$vo): ++$i; ?>
							<a title="<?php echo $vo['name']; ?>"  target="_self" href="<?php echo $vo['url']; ?>"><?php echo $vo['name']; ?></a>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div>
			...
			<section class="col-sm-8">
				<div class="clearfix pt_10">
					<h3 class="pull-left"> 风格分类-全部音乐</h3>
				</div>
				<hr class="">
				<div class="clearfix mt_10 ">
					<?php $param = []; $param["status"]=1;$param["result"] = "lv";$param["page"] = 1;$param["limit"] = 20;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(!empty($__MUSIC__)) : $lv_page = $__MUSIC__->render();$lv_total = $__MUSIC__->total(); else: $lv_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$lv): ++$i; ?>
					<div class="mb_10 clearfix relative play_box">
						<div class="row clearfix song_list">
