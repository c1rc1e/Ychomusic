<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\PHPTutorial\WWW\resources\web\default\home\ranks_index.html";i:1502267648;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
	...
	<div class="container">	
		<div class="row clearfix">
			<aside class="col-sm-2">
				<h2 class="pt_10">音乐排行榜单</h2>
				<hr>	
				<div class="sidebar_content">
					<ul class="main_menu c_rank">
						<?php $param = []; $param["status"]=1;$param["result"] = "vo";$param["order"] = "id asc";$ranksModel = isset($ranksModel)?$ranksModel:new \app\common\model\Ranks();$__MUSIC__ = $ranksModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$vo): ++$i; ?>
						<li class="">
						    <a class="" href="<?php echo $vo['url']; ?>">
                                <i class="jy jy-radio mr_5"></i><?php echo $vo['name']; ?>
                            </a>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
			...
			<section class="col-sm-10">
                <div class="row">
                    <?php $param = []; $param["status"]=1;$param["result"] = "rank";$param["limit"] = 9;$param["order"] = "id asc";$ranksModel = isset($ranksModel)?$ranksModel:new \app\common\model\Ranks();$__MUSIC__ = $ranksModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$rank): ++$i; ?>
                    <div class="col-sm-4 mt_20">
                        <div class="clearfix new-title">
                            <h2 class="pull-left"><?php echo $rank['name']; ?></h2>
                            <div class="more mb_10">
                                <a href="<?php echo $rank['url']; ?>">查看完整榜单</a>
                            </div>
                        </div>
                        <hr class="mb_15">
                        <?php $param = []; $param["status"]=1;$param["result"] = "lv";$param["rank"] = $rank['id'];$param["cache"] = 86400;$param["limit"] = 10;$param["order"] = "id";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$lv): ++$i; ?>
