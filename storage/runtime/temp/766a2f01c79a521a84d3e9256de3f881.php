<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"D:\PHPTutorial\WWW/app/admin\view\album\index.html";i:1523008918;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
    ...
    <div class="col-lg-12">
        <div class="btn-toolbar m-t-20" role="toolbar">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li <?php if(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty())): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo url('index'); ?>">
                            全部
                        </a>
                    </li>
                    <?php $_result=get_album_types();if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
                    <li <?php if($type == $t['id']): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo url('?type='.$t['id']); ?>">
                            <?php echo $t['name']; ?>
                        </a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>

                    <li <?php if($type == 'other'): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo url('?type=other'); ?>">
                            其它
                        </a>
                    </li>
                </ul>
            ...
            <table class="table table-hover mails m-0 table table-actions-bar">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo url('songs/index',['album'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></td>  
                        <td><?php echo $vo['artist_name']; ?></td>
                        <td><?php echo !empty($data['type_name'])?'' : $data['type_name']; ?></td>
