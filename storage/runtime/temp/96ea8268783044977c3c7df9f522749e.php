<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\PHPTutorial\WWW\resources\web\default\home\index_index.html";i:1515660067;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
...
<?php echo hook('indexSlider', ['widget'=>'Slider']); ?>
<div class="page_content_offset">
	<div class="container">
		<div class="row clearfix ">
			<div class="col-sm-8">
				<div class="new-title clearfix mb_15">
					<h2 class="pull-left hidden-xs"><i class="jy jy-hot-s mr_10"></i>歌曲TOP12</h2>
					<ul class="pull-right tabs_nav mb_10" role="tablist">
				...
				<div class="tab-content mb_15">
					<div class="tab-pane fade" id="listens">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["pos"] = 1;$param["limit"] = 12;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<div class="mb_10 clearfix relative play_box">
							<div class="row clearfix song_list">
								...
								<span class="col-sm-2 col-xs-2 ls_btns">
									...
									<a data-id="<?php echo $v['id']; ?>" data-action="fav" href="javascript:;"><i class="jy jy-like"></i></a>
					...
					<div class="tab-pane fade" id="hot">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 12;$param["order"] = "listens";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<div class="mb_10 clearfix relative play_box">
							<div class="row clearfix song_list">
								<span class="col-sm-5 col-xs-8">
									<span class="ls_num <?php if($i < '4'): ?>ls_num_top<?php endif; ?>"><?php echo $i; ?></span>
								...
								<span class="col-sm-2 col-xs-2 ls_btns">
									<a class="hidden-xs" target="_down" href="<?php echo $v['down_url']; ?>"><i class="jy jy-cloud-down-f"></i></a>
									<a data-id="<?php echo $v['id']; ?>" data-action="fav" href="javascript:;">
										<i class="jy jy-like"></i>
									</a>
									<a class="jp-play-me" data-id="<?php echo $v['id']; ?>" href="javascript:;">
					...
					<div class="tab-pane fade in active" id="new">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 12;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<div class="mb_10 clearfix relative play_box">
							<div class="row clearfix song_list">
								<span class="col-sm-5 col-xs-8">
									<span class="ls_num <?php if($i < '4'): ?>ls_num_top<?php endif; ?>"><?php echo $i; ?></span>
			...
			<div class="col-sm-4">
				<div class="clearfix new-title mb_15">
					<h2 class="pull-left">推荐专辑</h2>
					<div class="more mb_10">
						<a href="<?php echo url("home/Album/index");?>">更多>></a>
					</div>
				</div>
				<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["pos"] = 1;$param["limit"] = 5;$param["order"] = "update_time";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
				<div class="clearfix row">
					<div class="col-sm-4 col-xs-5">
						<a href="<?php echo $v['url']; ?>" target="_album" class="pull-left rca_cover">
					...
					<div class="col-sm-8 col-xs-7 pl_0">
						...
						<p class="small"><?php echo time_format($v['create_time'],'Y-m-d'); ?> ，<?php echo $v['hits']; ?>次浏览</p>
		...
		<div class="clearfix new-title">
			<h2 class="pull-left mb_15">
				<i class="jy jy-new-s mr_10"></i>新碟上架
				<a href="<?php echo url("home/Album/index");?>" class="">/更多</a>
			</h2>
			<div class="pull-right clearfix">
				<button class="button_type_7 pull-left bestalbum_prev">
					<i class="jy jy-left"></i>
				</button>
				<button class="button_type_7 pull-left ml_5 bestalbum_next">
					<i class="jy jy-right"></i>
				</button>
			</div>
		</div>
		<div class="bestalbum_carousel mb_30">
			<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 10;$param["order"] = "create_time";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
			<figure class="photoframe shadow relative tr_all_hover animate_ftb">
				<a href="<?php echo $v['url']; ?>" target="_album" title="<?php echo $v['name']; ?>" class="d_block relative wrapper a_cover">
					<img class="tr_all_hover"  src="<?php echo $v['cover_url']; ?>" alt="<?php echo $v['name']; ?>">
					<span class="clearfix p_buttons d_block tr_all_hover">
						<button class="add_fav btn_5 tr_delay_hover pull-left" title="收藏专辑" data-action="fav"  data-id="<?php echo $v['id']; ?>" data-type="album">
							<i class="jy jy-like"></i>
						</button>
						<span class=" btn_5 tr_delay_hover pull-left album_play" title="播放专辑" data-id="<?php echo $v['id']; ?>">
							<i class="jy jy-play"></i>
						</span>
					</span>
				</a>
				<figcaption class="clearfix">
					<h5 class="mb_10 mt_10">
						<a href="<?php echo $v['url']; ?>" target="_album" title="<?php echo $v['name']; ?>" class="ellipsis"><?php echo $v['name']; ?></a>
					</h5>
					<p class="scheme_color  pull-left">
						<i class="jy jy-fire"></i><?php echo $v['hits']; ?>
					</p>
				</figcaption>
			</figure>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="row clearfix mb_30">
			...
			<div class="col-md-7 col-sm-12 ">
				<div class="clearfix new-title mb_10">
					<h2 class="pull-left"><i class="jy jy-hot-s mr_10"></i>音乐人</h2>
					<div class="more mb_10">
						<a target="_blank" href="<?php echo url("home/Artist/index");?>">更多>></a>
					</div>
				</div>

				<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["pos"] = 1;$param["limit"] = 9;$param["order"] = "update_time";$artistModel = isset($artistModel)?$artistModel:new \app\common\model\Artist();$__MUSIC__ = $artistModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
				<div class="<?php if($i == '1'): ?>col-sm-4 c_md<?php else: ?>col-sm-2 c_sm<?php endif; ?> col-xs-6">
			...
			<div class="col-md-5 col-sm-12">
				<div class="clearfix new-title mb_15">
					<h2 class="pull-left"><i class="jy jy-hot-s mr_10"></i>分类精选</h2>
					<div class="more mb_10">
						<a target="_genre" title="音乐分类" href="<?php echo url("home/Genre/index");?>">更多>></a>
					</div>
				</div>
				<div class="clearfix s_cats">
					<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["limit"] = 20;$genreModel = isset($genreModel)?$genreModel:new \app\common\model\Genre();$__MUSIC__ = $genreModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
					<a title="<?php echo $v['name']; ?>" target="_genre" href="<?php echo $v['url']; ?>"><?php echo $v['name']; ?></a>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
		</div>
		<div class="row clearfix mb_20">
			<div class="col-md-12">
				<div class="clearfix new-title mb_15">
					<h2 class=" pull-left mb_10">
						<i class="jy jy-hot-s mr_10"></i>分享达人
						<a href="#" class="animate_ftr">/更多</a>
					</h2>
					<div class="pull-right clearfix nav_buttons_wrap animate_fade">
						<button class="button_type_7 bg_cs_hover pull-left tr_delay_hover  bestuser_prev"><i class="jy jy-left"></i></button>
						<button class="button_type_7 bg_cs_hover pull-left ml_5 tr_delay_hover  bestuser_next"><i class="jy jy-right"></i></button>
					</div>
				</div>

				<div class="bestuser_carousel mb_10">
					<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["limit"] = 10;$param["order"] = "songs";$memberModel = isset($memberModel)?$memberModel:new \app\common\model\Member();$__MUSIC__ = $memberModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
					<figure class="photoframe shadow relative tr_all_hover animate_ftb t_align_c">
						<div class="circle wrapper u_cover mb_15">
							<a href="<?php echo $v['url']; ?>" target="_blank" class="t_align_c"><img alt="<?php echo $v['nickname']; ?>" src="<?php echo $v['avatar']; ?>"></a>
						</div>
						<figcaption>
		...
		<div class="row clearfix mb_20">
			<div class="col-md-12">
				...
				<ul><?php echo hook('pageFooter', ['widget'=>'links']); ?></ul>
			</div>
		</div>
	</div>
</div>
