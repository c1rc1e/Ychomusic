<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"D:\PHPTutorial\WWW/app/admin\view\artist\index.html";i:1511192596;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li <?php if($type == $t['id']): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo url('?type='.$t['id']); ?>"><?php echo $t['name']; ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>

                    <li <?php if($type == 'other'): ?>class="active"<?php endif; ?>>
                        <a href="<?php echo url('?type=other'); ?>">其它</a>
                    </li>
                </ul>
            </div>

            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo url('create'); ?>">新增艺人</a>
            </div>
            ...
            <table class="table table-hover mails m-0 table table-actions-bar">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:vod(0)"><?php echo $vo['type_name']; ?></a></td>
                        <td><a href="javascript:vod(0)"><?php echo $vo['region']; ?></a></td>
