<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\PHPTutorial\WWW\resources\web\default\user\fav_index.html";i:1502218637;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_common.html";i:1502370209;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;}*/ ?>
<!doctype html>
...
<div class="tabbable tabbable-custom tabbable-reversed">
	<ul class="nav nav-tabs">
		<li class="active">
			<a href="<?php echo url("user/Fav/index");?>">歌曲收藏</a>
		</li>
		<li>
			<a href="<?php echo url("user/Fav/album");?>">专辑收藏</a>
		</li>
	</ul>
	<div class="tab-content clearfix">
		...
		<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["page"] = 1;$param["uid"] = $user['uid'];$param["limit"] = 20;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getFavList($param);if(!empty($__MUSIC__)) : $v_page = $__MUSIC__->render();$v_total = $__MUSIC__->total(); else: $v_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
		<div class="mb_10 clearfix relative play_box">
			<div class="row clearfix song_list">								
				...
				<span class="col-sm-2 hidden-xs singer">
					<a href="<?php echo $v['genre_url']; ?>"><?php echo $v['genre_name']; ?></a>
				</span>
				<span class="col-sm-2 col-xs-2 ls_btns">							
					<a class="music-action-btn hidden-xs" data-id="<?php echo $v['id']; ?>" data-action="fav" href="javascript:;">
