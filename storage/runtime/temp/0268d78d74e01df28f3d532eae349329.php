<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\PHPTutorial\WWW\resources\web\default\home\genre_detail.html";i:1516268072;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
			...
			<aside class="col-sm-4">
				...
				<div class="sidebar_content">
					<div class="clearfix s_cats">
						<?php $param = []; $param["status"]=1;$param["result"] = "vo";$param["limit"] = 20;$genreModel = isset($genreModel)?$genreModel:new \app\common\model\Genre();$__MUSIC__ = $genreModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$vo): ++$i; ?>
							<a title="<?php echo $vo['name']; ?>" target="_self" <?php if($vo['id'] == $data['id']): ?>class="active"<?php endif; ?> target="_blank" href="<?php echo $vo['url']; ?>"><?php echo $vo['name']; ?></a>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						<a title="全部"  target="_genre" href="<?php echo url('/genre'); ?>">全部</a>
					</div>
				</div>
			...
			<section class="col-sm-8">
				<div class="clearfix pt_10">
					<ul class="pull-right tabs_nav" role="tablist">
						<li <?php if($sort == 'new'): ?>class="active"<?php endif; ?>><a class="tr_delay_hover" href="<?php echo $data['url_new']; ?>">热门试听</a></li>
						<li <?php if($sort == 'hot'): ?>class="active"<?php endif; ?>><a class="tr_delay_hover"  href="<?php echo $data['url_hot']; ?>">最新添加</a></li>
					</ul>

					<h3 class="pull-left"><?php echo $data['name']; ?> - 全部音乐</h3>
				</div>
				<hr class="">
				<div class="clearfix mt_10 ">
					<?php $param = []; $param["status"]=1;$param["result"] = "lv";$param["page"] = 1;$param["genre"] = $data['id'];$param["limit"] = 20;$param["order"] = $order;$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(!empty($__MUSIC__)) : $lv_page = $__MUSIC__->render();$lv_total = $__MUSIC__->total(); else: $lv_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$lv): ++$i; ?>
					<div class="mb_10 clearfix relative play_box">
						<div class="row clearfix song_list">
...
$(document).ready(function () {
    $.ajax({
        ...
        data: {id: "<?php echo $data['id']; ?>", type : 'genre'},
        dataType: "jsonp"
    });
});
</script>
