<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"D:\PHPTutorial\WWW\resources\web\default\home\album_index.html";i:1503390285;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_common.html";i:1540551673;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_header.html";i:1540542982;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\sidebar_adver.html";i:1502218637;s:64:"D:\PHPTutorial\WWW\resources\web\default\home\public_footer.html";i:1540552015;s:65:"D:\PHPTutorial\WWW\resources\web\default\home\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
...
<div class="page_content_offset">
	<div class="container">	
		<div class="row clearfix">
			...
			<section class="col-sm-8 pt_10">				
					...
					<div class="col-sm-8 col-xs-7 t_align_l ">
						<div class="clearfix ml_10">
							<div class="custom_select relative pull-right t_align_l">
								<div class="select_title  relative color_dark">全部专辑</div>
								<ul class="select_list d_none">
									<li class="tr_delay_hover"><a href="<?php echo url("home/Album/index");?>">全部专辑</a></li>
									<?php $param = []; $param["status"]=1;$param["result"] = "vo";$param["cache"] = 72000;$albumTypeModel = isset($albumTypeModel)?$albumTypeModel:new \app\common\model\AlbumType();$__MUSIC__ = $albumTypeModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$vo): ++$i; ?>
				...
				<hr class="mb_10">
				<?php $param = []; $param["status"]=1;$param["result"] = "vo";$param["page"] = 1;$param["limit"] = 12;$param["order"] = "create_time";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(!empty($__MUSIC__)) : $vo_page = $__MUSIC__->render();$vo_total = $__MUSIC__->total(); else: $vo_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$vo): ++$i; ?>
				<div class="row clearfix a_list">
					...
					<div class="col-sm-6 col-xs-8">
						...
						<p class="scheme_color mb_15">
							发行时间：<?php echo (isset($vo['pub_time']) && ($vo['pub_time'] !== '')?$vo['pub_time']:"未知"); ?>
							唱片公司：<?php echo (isset($vo['company']) && ($vo['company'] !== '')?$vo['company']:"暂无"); ?>
						</p>
					...
					<div class="col-sm-3 t_align_r ">
						<p class="scheme_color mb_15">
							<span class="fw_medium">
								...
								<?php echo time_format($vo['create_time'],'Y-m-d'); ?>
							</span>
						</p>
						<p class="scheme_color mb_15">
                        ...
                        <button class="btn_1 tr_all_hover mb_15"  data-id="<?php echo $vo['id']; ?>" data-action="fav" data-type="album" href="javascript:;">
                        <i class="jy jy-fav"></i>
                        </button><br class="d_sm_none">
                        <button class="album_play btn_4 tr_all_hover pull-right" title="<?php echo $vo['name']; ?>" data-id="<?php echo $vo['id']; ?>">播放专辑</button>
					</div>	
				</div>
				<hr class="mb_10">
				<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    这是广告位！！
				...
				<h2 class="pt_10">音乐人<a href="<?php echo url("home/Artist/index");?>" class="">/更多</a></h2>
				<hr>
				<div class="sidebar_content">
					<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["cache"] = 86400;$param["limit"] = 10;$param["order"] = "hits";$artistModel = isset($artistModel)?$artistModel:new \app\common\model\Artist();$__MUSIC__ = $artistModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
					<div class="clearfix ">
