<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\PHPTutorial\WWW\resources\web\default\article\site_detail.html";i:1502218637;s:67:"D:\PHPTutorial\WWW\resources\web\default\article\public_common.html";i:1510930532;s:67:"D:\PHPTutorial\WWW\resources\web\default\article\public_header.html";i:1540464178;s:67:"D:\PHPTutorial\WWW\resources\web\default\article\public_footer.html";i:1540464763;}*/ ?>
<!doctype html>
...
<div class="page_content_offset">
			...
			<aside class="col-sm-3">
				...
				<div class="sidebar_content">
					<ul class="main_menu c_rank">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$siteModel = isset($siteModel)?$siteModel:new \app\common\model\Site();$__MUSIC__ = $siteModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<li class="<?php if($v['name'] == $data['name']): ?> current<?php endif; ?>">
				...
				<div class="sidebar_content">
					<ul class="main_menu c_rank">
						<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["cache"] = 86400;$param["type"] = "help";$siteModel = isset($siteModel)?$siteModel:new \app\common\model\Site();$__MUSIC__ = $siteModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
						<li class="<?php if($v['name'] == $data['name']): ?>current<?php endif; ?>">
							<a class="mb_0" title="<?php echo $v['title']; ?>" href="<?php echo $v['url']; ?>"><?php echo $v['title']; ?></a>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<article class="mb_15">
					<div class="row clearfix mb_15">
						<div class="col-lg-9 col-md-9 col-sm-8">
							<h2 class="mb_5 fw_medium m_xs_bottom_10"><?php echo $data['title']; ?></h2>
						</div>
					</div>
					<hr class=" mb_20">
					<!--文章-->
	...
	<div class="container hidden-xs">
		<div class="row clearfix">
			<div class="col-sm-6">
				<h3><?php echo config('WEB_SITE_NAME'); ?></h3>
				<p><?php echo config('WEB_SITE_DESCRIPTION'); ?></p>
			</div>
			<div class="col-sm-2">
				<h3>关于网站</h3>
