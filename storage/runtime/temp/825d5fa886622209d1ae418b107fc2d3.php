<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\PHPTutorial\WWW\resources\web\default\user\relation_fans.html";i:1517322207;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_common.html";i:1502370209;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;}*/ ?>
<!doctype html>
...
<div class="tabbable tabbable-custom tabbable-reversed">
	<ul class="nav nav-tabs">
		<li>
			<a href="<?php echo url("user/Relation/follow");?>">我的关注</a>
		</li>
		<li class="active">
			<a href="<?php echo url("user/Relation/fans");?>">我的粉丝</a>
		</li>
	</ul>
	<div class="tab-content clearfix">
		<div class="row clearfix album_list">
			<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["uid"] = $user['uid'];$param["page"] = 1;$param["limit"] = 20;$memberModel = isset($memberModel)?$memberModel:new \app\common\model\Member();$__MUSIC__ = $memberModel->getFans($param);if(!empty($__MUSIC__)) : $v_page = $__MUSIC__->render();$v_total = $__MUSIC__->total(); else: $v_page = null; endif;if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
			<div class="col-sm-3">
				<a class="acover" href="<?php echo $v['url']; ?>"> <img alt="<?php echo $v['nickname']; ?>" src="<?php echo $v['avatar']; ?>"></a>
				<span class="aname text-ellipsis">
				<a href="<?php echo $v['url']; ?>"> <?php echo $v['nickname']; ?></a>
				</span>
			</div>
