<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\PHPTutorial\WWW\resources\web\default\user\index_read.html";i:1502218637;s:63:"D:\PHPTutorial\WWW\resources\web\default\user\index_common.html";i:1522921022;s:62:"D:\PHPTutorial\WWW\resources\web\default\user\public_head.html";i:1540551672;s:64:"D:\PHPTutorial\WWW\resources\web\default\user\public_footer.html";i:1540552004;s:65:"D:\PHPTutorial\WWW\resources\web\default\user\player_default.html";i:1502218637;}*/ ?>
<!doctype html>
...
<div class="row">
	<div class="col-sm-8">
		<div class="header">TA的分享<a class="more" href="<?php echo url("user/Index/music", ["uid" => $user["uid"]]);?>">更多&gt;&gt;</a></div>
		<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["uid"] = $user['uid'];$param["cache"] = 7200;$param["limit"] = 10;$param["order"] = "create_time";$songsModel = isset($songsModel)?$songsModel:new \app\common\model\Songs();$__MUSIC__ = $songsModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
		...
		<div class="header">TA的专辑<a class="more" href="<?php echo url("user/Index/album", ["uid" => $user["uid"]]);?>">更多&gt;&gt;</a></div>
		<div class="row clearfix album_list">
			<?php $param = []; $param["status"]=1;$param["result"] = "v";$param["uid"] = $user['uid'];$param["cache"] = 7200;$param["limit"] = 6;$param["order"] = "create_time";$albumModel = isset($albumModel)?$albumModel:new \app\common\model\Album();$__MUSIC__ = $albumModel->getList($param);if(is_array($__MUSIC__) || $__MUSIC__ instanceof \think\Collection || $__MUSIC__ instanceof \think\Paginator): $__JYLIST__ = $__MUSIC__;if( count($__JYLIST__)==0 ) : echo "" ;else: $i=0; foreach($__JYLIST__ as $key=>$v): ++$i; ?>
			<div class="col-sm-4">
				<a class="acover" href="<?php echo $v['url']; ?>"> <img alt="<?php echo $v['name']; ?>" src="<?php echo $v['cover_url']; ?>"></a>
...
$(document).ready(function () {
    $.ajax({
        ...
        data: {id: "<?php echo $user['uid']; ?>", type : 'album'},
        dataType: "jsonp"
    });
});
</script>
