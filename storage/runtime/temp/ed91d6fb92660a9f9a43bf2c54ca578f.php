<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"D:\PHPTutorial\WWW/app/admin\view\message\index.html";i:1523009171;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\base.html";i:1540553179;s:53:"D:\PHPTutorial\WWW\app\admin\view\public\sidebar.html";i:1497743216;s:50:"D:\PHPTutorial\WWW\app\admin\view\public\tool.html";i:1500709188;}*/ ?>
    ...
    <div class="col-lg-12">
        <div class="btn-toolbar m-t-20" role="toolbar">
            ...
            <div class="btn-group pull-right">
                ...
                <button class="btn btn-danger delete-batch" data-tip="" data-target=".check-ids"  data-url="<?php echo url('delete'); ?>" type="button">
                    删除
                </button>
            </div>
            ...
            <table class="table table-hover mails m-0 table table-actions-bar">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['post_uname']; ?></td>                
                        <td><?php echo $vo['to_uname']; ?></td>
                        ...
                        <td>
                            ...
                            <?php if($vo['status'] == 1): ?>
                            <a class="table-action-btn ajax-get" title="禁用" href="<?php echo url('setStatus?id='.$vo['id'].'&status=0'); ?>">
                                <i class="fa fa-ban text-warning"></i>
                            </a>
                            <?php elseif($vo['status'] == 0): ?>
                            <a class="table-action-btn ajax-get" title="启用" href="<?php echo url('setStatus?id='.$vo['id'].'&status=1'); ?>">
                                <i class="fa fa-check-circle-o text-success"></i>
                            </a>
                            <?php endif; ?>
                            <a href="<?php echo url('delete?id='.$vo['id']); ?>" class="table-action-btn ajax-del">
